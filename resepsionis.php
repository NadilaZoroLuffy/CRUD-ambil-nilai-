...
<head>
    ...
    <title>Data Nama Resepsionis</title>
...
<main id="main">
    <section id="about" class="about">
        ...
        <a href="tambahRSP.php" class="tambah">Tambah Data Resepsionis</a>
    ...
    <table border="1" cellpadding="10" cellspacing="0" class="tabl" >
        ...
        <?php foreach($resepsionis as $data) : ?>
            <tr>
                ...
                <td><?= $data["roles"]; ?></td>
                <td>
                    <a href="edit_rsp.php?id=<?= $data["id_resepsionis"]; ?>" class="btn-login">Edit</a>
                    <a href="hapusrsp.php?id=<?= $data["id_resepsionis"]; ?>" onClick="return confirm('Anda Yakin Menghapus Data Ini??')" class="btn-login-2">Hapus</a>
                </td>
            </tr>
            <?php $i++; ?>
            <?php endforeach; ?>
